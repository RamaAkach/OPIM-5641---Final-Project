# 🎶 Coachella & Glamour Portfolio — 2026-09-23
...
|-------|--------|--------|--------|----------|
| Abbvie | `ABBV` | Healthcare | **33.86%** | ✅ 1 |
| e.l.f. Beauty | `ELF` | Beauty | **16.38%** | ✅ 1 |
| Nvidia | `NVDA` | Tech | **8.85%** | ✅ 1 |
| Johnson & J | `JNJ` | Healthcare | **8.42%** | ✅ 1 |
| Microsoft | `MSFT` | Tech | **7.50%** | ✅ 1 |
...
|--------|--------------|---------------|
| Annualised Return | **71.98%** | 14.55% |
| Annualised Risk   | 16.49% | 12.76% |
| Sharpe Ratio      | **4.062** | 0.748 |
| Max Drawdown      | — | -4.49% |
...
Return vs Buy-and-Hold SPY: **nan%** vs 0.72%
...
---
*Auto-generated by GitHub Actions · 2026-09-23 · OPIM 5641*