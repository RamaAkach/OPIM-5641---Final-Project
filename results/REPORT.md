# 🎶 Coachella & Glamour Portfolio — 2026-09-16
...
|-------|--------|--------|--------|----------|
| Abbvie | `ABBV` | Healthcare | **31.59%** | ✅ 1 |
| e.l.f. Beauty | `ELF` | Beauty | **12.60%** | ✅ 1 |
| Nvidia | `NVDA` | Tech | **12.55%** | ✅ 1 |
| Johnson & J | `JNJ` | Healthcare | **9.55%** | ✅ 1 |
| Apple | `AAPL` | Tech | **8.71%** | ✅ 1 |
...
|--------|--------------|---------------|
| Annualised Return | **59.76%** | 16.38% |
| Annualised Risk   | 15.97% | 12.69% |
| Sharpe Ratio      | **3.429** | 0.896 |
| Max Drawdown      | — | -4.49% |
...
Return vs Buy-and-Hold SPY: **-3.34%** vs 3.83%
...
---
*Auto-generated by GitHub Actions · 2026-09-16 · OPIM 5641*