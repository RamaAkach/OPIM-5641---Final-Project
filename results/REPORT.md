# 🎶 Coachella & Glamour Portfolio — 2026-07-08
...
|-------|--------|--------|--------|----------|
| UnitedHealth | `UNH` | Healthcare | **33.95%** | ✅ 1 |
| SiriusXM | `SIRI` | Music | **26.05%** | ✅ 1 |
...
|--------|--------------|---------------|
| Annualised Return | **82.58%** | 29.96% |
| Annualised Risk   | 17.04% | 14.83% |
| Sharpe Ratio      | **4.553** | 1.683 |
| Max Drawdown      | — | -8.58% |
...
Return vs Buy-and-Hold SPY: **6.48%** vs 1.49%
...
---
*Auto-generated by GitHub Actions · 2026-07-08 · OPIM 5641*