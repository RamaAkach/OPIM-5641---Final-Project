# 🎶 Coachella & Glamour Portfolio — 2026-06-05
...
|-------|--------|--------|--------|----------|
| SiriusXM | `SIRI` | Music | **30.39%** | ✅ 1 |
| Apple | `AAPL` | Tech | **23.30%** | ✅ 1 |
| UnitedHealth | `UNH` | Healthcare | **8.16%** | ✅ 1 |
| Nvidia | `NVDA` | Tech | **8.15%** | ✅ 1 |
...
|--------|--------------|---------------|
| Annualised Return | **53.30%** | 31.52% |
| Annualised Risk   | 17.38% | 13.39% |
| Sharpe Ratio      | **2.779** | 1.980 |
| Max Drawdown      | — | -8.88% |
...
Return vs Buy-and-Hold SPY: **2.78%** vs 7.90%
...
---
*Auto-generated by GitHub Actions · 2026-06-05 · OPIM 5641*