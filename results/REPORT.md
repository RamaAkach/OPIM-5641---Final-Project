# 🎶 Coachella & Glamour Portfolio — 2026-07-06
...
|-------|--------|--------|--------|----------|
| UnitedHealth | `UNH` | Healthcare | **34.41%** | ✅ 1 |
| SiriusXM | `SIRI` | Music | **25.59%** | ✅ 1 |
...
|--------|--------------|---------------|
| Annualised Return | **82.95%** | 29.30% |
| Annualised Risk   | 17.16% | 14.91% |
| Sharpe Ratio      | **4.542** | 1.630 |
| Max Drawdown      | — | -8.58% |
...
Return vs Buy-and-Hold SPY: **6.49%** vs 1.09%
...
---
*Auto-generated by GitHub Actions · 2026-07-06 · OPIM 5641*