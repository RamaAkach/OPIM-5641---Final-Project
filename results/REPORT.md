# 🎶 Coachella & Glamour Portfolio — 2026-06-02
...
|-------|--------|--------|--------|----------|
| SiriusXM | `SIRI` | Music | **36.93%** | ✅ 1 |
| Nvidia | `NVDA` | Tech | **14.57%** | ✅ 1 |
| Apple | `AAPL` | Tech | **10.77%** | ✅ 1 |
| Live Nation | `LYV` | Music | **7.73%** | ✅ 1 |
...
|--------|--------------|---------------|
| Annualised Return | **66.55%** | 37.25% |
| Annualised Risk   | 18.22% | 13.58% |
| Sharpe Ratio      | **3.378** | 2.376 |
| Max Drawdown      | — | -8.88% |
...
Return vs Buy-and-Hold SPY: **2.97%** vs 8.37%
...
---
*Auto-generated by GitHub Actions · 2026-06-02 · OPIM 5641*