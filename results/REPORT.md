# 🎶 Coachella & Glamour Portfolio — 2026-05-08
...
|-------|--------|--------|--------|----------|
| SiriusXM | `SIRI` | Music | **30.14%** | ✅ 1 |
| Alphabet | `GOOGL` | Tech | **26.10%** | ✅ 1 |
| Johnson & J | `JNJ` | Healthcare | **8.64%** | ✅ 1 |
| UnitedHealth | `UNH` | Healthcare | **5.13%** | ✅ 1 |
...
|--------|--------------|---------------|
| Annualised Return | **51.72%** | 18.09% |
| Annualised Risk   | 17.35% | 13.78% |
| Sharpe Ratio      | **2.693** | 0.950 |
| Max Drawdown      | — | -8.88% |
...
Return vs Buy-and-Hold SPY: **5.76%** vs 11.63%
...
---
*Auto-generated by GitHub Actions · 2026-05-08 · OPIM 5641*