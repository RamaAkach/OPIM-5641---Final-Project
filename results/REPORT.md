# 🎶 Coachella & Glamour Portfolio — 2026-08-28
...
|-------|--------|--------|--------|----------|
| Abbvie | `ABBV` | Healthcare | **25.52%** | ✅ 1 |
| UnitedHealth | `UNH` | Healthcare | **18.22%** | ✅ 1 |
| Nvidia | `NVDA` | Tech | **14.41%** | ✅ 1 |
| e.l.f. Beauty | `ELF` | Beauty | **8.65%** | ✅ 1 |
| SiriusXM | `SIRI` | Music | **7.77%** | ✅ 1 |
...
|--------|--------------|---------------|
| Annualised Return | **59.56%** | 30.53% |
| Annualised Risk   | 14.11% | 12.67% |
| Sharpe Ratio      | **3.868** | 2.015 |
| Max Drawdown      | — | -4.49% |
...
Return vs Buy-and-Hold SPY: **2.61%** vs 2.14%
...
---
*Auto-generated by GitHub Actions · 2026-08-28 · OPIM 5641*